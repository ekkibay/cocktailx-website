 ...
 *
 * Getränke tragen 56 bis 77% Deckungsbeitrag, Personal nur 17%. Ein Rabatt auf die
 ...
 * wird kein Preis mehr angezeigt, sondern auf ein persönliches Angebot verwiesen, * damit nie eine Konfiguration rausgeht, die Geld kostet.
 */
