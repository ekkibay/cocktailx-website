...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: {
      de: "67 Bars, 174+ exklusive Cocktails und 18 Tage voller Genuss \u2013 entdecke das komplette Festival-Programm.",
      en: "67 bars, 174+ exclusive cocktails, and 18 days of indulgence \u2013 discover the complete festival program.",
    },
    content: {
      de: "Wir freuen uns, das vollst\u00e4ndige Line-Up f\u00fcr das Cocktail X Festival 2026 bekannt zu geben. Dieses Jahr erwarten euch 67 teilnehmende Bars aus ganz M\u00fcnchen, 174+ exklusive Cocktailkreationen und 18 unvergessliche Tage. Von der Goldenen Bar bis zur Zephyr Bar \u2013 jede Location hat einen einzigartigen Signature Cocktail f\u00fcr das Festival kreiert.",
      en: "We are excited to announce the complete line-up for the Cocktail X Festival 2026. This year, you can look forward to 67 participating bars from across M\u00fcnchen, 174+ exclusive cocktail creations, and 18 unforgettable days. From Goldene Bar to Zephyr Bar \u2013 each location has created a unique signature cocktail for the festival.",
    },
    date: "2026-03-15",
