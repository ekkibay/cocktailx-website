...
export const events: FestivalEvent[] = [
  ...
  },
  {
    ...
    description: {
      de: "Der exklusive Auftakt des Cocktail X Festivals 2026 – Daydrinking auf einer der schönsten Rooftop-Terrassen Münchens. All you can drink Cocktails, Canapés, Live DJ und professioneller Content. Limitiert auf 180 Gäste.",
      en: "The exclusive opening of Cocktail X Festival 2026 – daydrinking on one of Munich's most beautiful rooftop terraces. All you can drink cocktails, canapés, live DJ and professional content. Limited to 180 guests.",
    },
    ...
    tickets: [
      {
        ...
        price: 49,
        note: { de: "Limitiert · All you can drink + Canapés inkl.", en: "Limited · All you can drink + canapés incl." },
        badge: "LIMITIERT",
      },
      {
        label: { de: "Regular", en: "Regular" },
        price: 59,
        note: { de: "All you can drink + Canapés inkl.", en: "All you can drink + canapés incl." },
      },
    ],
